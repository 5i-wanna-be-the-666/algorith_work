...
<%@ page import="user_role.UserRoleDAO" %> 
...
BufferedReader bw = null;
  File file = new File("D://Myeclipse2020//software_qk/jijia.txt");
           ...
           jijia=Double.parseDouble(bw.readLine());
session.setAttribute("jijia",jijia);
%>
		...
		<div class="wrap-login100">
			...
			<form class="login100-form validate-form" action="Login_page" method="post">
				...
				<div class="text-center p-t-12">
					<a class="txt2" href="http://localhost:8080/true_software/find_passwd">
						忘记密码？
					</a>
				</div>

				<div class="text-center p-t-136">
					<a class="txt2" href="http://localhost:8080/true_software/zhuce">
							还没有账号？立即注册
